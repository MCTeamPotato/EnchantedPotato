...
public class NatureBlessingConfig {
    ...
    public static final ForgeConfigSpec.DoubleValue BASE_HEAL_AMOUNT, GAINED_HEAL_AMOUNT_PER_LEVEL, BASE_RADIUS, GAINED_RADIUS_PER_LEVEL, MIN_DAMAGE, MAX_DAMAGE, DAMAGE_BONUS_PER_LEVEL, BASE_KNOCKBACK_STRENGTH, GAINED_KNOCKBACK_STRENGTH_PER_LEVEL;
