...
public class ModPackets {
    public static final SimpleChannel CHANNEL = NetworkRegistry.newSimpleChannel(ResourceLocation.tryParse(EnchantedPotato.MOD_ID + ":main"), () -> "1.0", s -> true, s -> true);
    ...
    public static void register() {
        ...
        CHANNEL.messageBuilder(SpaceLeapfrogPacket.class, packetId++, NetworkDirection.PLAY_TO_SERVER).encoder(SpaceLeapfrogPacket::encode).decoder(SpaceLeapfrogPacket::decode).consumer(SpaceLeapfrogPacket::handle).add();
    }
}
