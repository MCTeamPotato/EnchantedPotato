...
public abstract class AbstractOverlay implements IGuiOverlay {
    ...
    @Override
    public void render(ForgeGui gui, PoseStack guiGraphics, float partialTick, int screenWidth, int screenHeight) {
        ...
        if (value > 0) {
            ...
            mc.font.draw(guiGraphics, text, getX(), yPos, 0xFFA500);
        }
    }
}
