...
public class ArmorBreaking extends Enchantment {
    ...
    public ArmorBreaking() {
        super(
                ...
                Utils.getSlots(EarlySetupInitializer.equipmentSlotConfig.armorBreaking)
        );
    }
    ...
    public boolean canApplyAtEnchantingTable(@NotNull ItemStack stack) {
        ...
        return EarlySetupInitializer.canApplyAtEnchantingTableConfig.armorBreaking && super.canApplyAtEnchantingTable(stack) && (item instanceof SwordItem || item instanceof AxeItem || item instanceof TridentItem);
    }
